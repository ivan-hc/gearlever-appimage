...
DEPENDENCES="7zip binutils dconf desktop-file-utils dwarfs-bin file fuse2 python python-gobject python-dbus  python-pyxdg python-requests squashfs-tools zlib" #SYNTAX: "APP1 APP2 APP3 APP4...", LEAVE BLANK IF NO OTHER DEPENDENCIES ARE NEEDED
...
BINSAVED="find ldconfig"
SHARESAVED="SAVESHAREPLEASE"
LIBSAVED="girepository Gio dbus python libdebuginfod libjson"
